...
type FileFieldsEnum =
  ...
  | 'childMarkdownRemark.frontmatter.oldId'
  ...
  | 'childrenMarkdownRemark.frontmatter.oldId'
...
type Unnamed_1_Query = { readonly allMarkdownRemark: { readonly group: ReadonlyArray<{ readonly fieldValue: string | null, readonly totalCount: number }>, readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: { readonly path: string | null } | null } }> } };
